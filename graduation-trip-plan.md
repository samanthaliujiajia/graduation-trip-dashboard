...
| 人员 | 你、父母、男友；父母 2026-05-29 18:30 落地 LAX；男友 2026-06-03 加入 |
| 预算 | 行程共同支出控制在约 `$10,000`；男友个人机票不计入该预算 |
...
| 日期 | 住宿/转场 | 工作版安排重点 |
| --- | --- | --- |
| 05/29 Fri | LAX → San Diego | 18:30 接父母后直达住宿，夜间仅转场 |
...
| 06/03 Wed | Los Angeles | 按男友航班弹性安排，接机后会合 |
...
6. 用户补充男友个人机票不计入整体旅行预算；工作版已删除 `$400` 机票预算项，预估共同支出调整为 `$6,900`，预算缓冲调整为 `$3,100`。
...
| 立即 | 男友抵达航班衔接 | 2026-06-03 到达 LAX 还是 SAN 及具体时间；票价不计入本预算 |
